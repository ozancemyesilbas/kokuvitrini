import {brands,products,SITE_URL} from '../lib/catalog';
...
export default function sitemap(){
 ...
 const productPages=products.map(p=>({url:`${SITE_URL}/urun/${p.slug}`,lastModified:now,changeFrequency:'weekly',priority:.8}));
